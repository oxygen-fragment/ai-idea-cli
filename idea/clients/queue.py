...
class QueueClient(BackendClient):
    ...
    async def execute_story(self, story_id: str, project_context: Dict[str, Any]) -> Dict[str, Any]:
        """
...
class QueueRunner:
    ...
    async def run_queue(self, dry_run: bool = False):
        ...
        raise NotImplementedError("Queue execution via backend service not yet implemented")